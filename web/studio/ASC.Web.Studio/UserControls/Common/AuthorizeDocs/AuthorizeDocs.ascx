    ...
    <div class="auth-form-head_w <%= Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName %>">
        <div class="auth-form-head">
            ...
            <div class="auth-form-with_try clearFix">
                <p class="auth-form-with_try_formats"><%= Resource.AuthDocsCompatibleText %>
                <p class="auth-form-with_try_formats"><%= Resource.AuthDocsRightBrowserText %>
                <p class="auth-form-with_try_formats"><%= Resource.AuthDocsFreeChargeText %>
    ...
    <div class="auth-form-with auth-form-share-collaborate">
        ...
        <div class="share-collaborate-picture-carousel">
            <div class="scpc-item" >
                ...
                <div class="share-collaborate-text-content active" id="Div1"><%=Resource.AuthDocsShareСollaborateInviteUsers%>
            ...
            <div class="scpc-item" >
                ...
                <div class="share-collaborate-text-content" id="collaborate2"><%=Resource.AuthDocsShareСollaborateSelectRight%>
                    <p class="share-collaborate-text-small-content">
            ...
            <div class="scpc-item" >
                ...
                <div class="share-collaborate-text-content" id="collaborate3"><%=Resource.AuthDocsShareСollaborateDiscuss%>
                    <p class="share-collaborate-text-small-content">
            ...
            <div class="scpc-item" >
                ...
                <div class="share-collaborate-text-content" id="collaborate4"><%=Resource.AuthDocsShareСollaborateReviewResults%>
                    <p class="share-collaborate-text-small-content">
            ...
            <div class="scpc-item" >
                ...
                <div class="share-collaborate-text-content" id="collaborate5"><%=Resource.AuthDocsShareСollaborateNavigateHistory%>
                    <p class="share-collaborate-text-small-content">
            ...
            <div class="scpc-item" >
                ...
                <div class="share-collaborate-text-content" id="collaborate6"><%=Resource.AuthDocsShareСollaborateEmberDocuments%>
                    <p class="share-collaborate-text-small-content">
