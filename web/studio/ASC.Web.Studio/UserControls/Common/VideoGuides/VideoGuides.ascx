...
<li class="menu-item none-sub-list video-guides add-block">
    <div class="category-wrapper">
        <a class="menu-item-label outer-text text-overflow video-link" href="<%= AllVideoLink %>" target="_blank" title="<%= Resource.VideoGuides %>">
            <span class="menu-item-icon video-guides"><svg class="menu-item-svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use base="<%= WebPath.GetPath("/")%>" href="/skins/default/images/svg/top-studio-menu.svg#svgTopStudioMenuvideo-guides" xlink:href="/skins/default/images/svg/top-studio-menu.svg#svgTopStudioMenuvideo-guides"></use></svg></span>
