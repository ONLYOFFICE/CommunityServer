...
namespace ASC.Web.Studio.UserControls.Management
{
    public partial class InviteLink : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _inviteLinkContainer.Options.IsPopup = true;
        ...
        {
            Page.RegisterInlineScript(string.Format(@"ZeroClipboard.setMoviePath('{0}');", CommonLinkUtility.ToAbsolute("~/js/flash/zeroclipboard/ZeroClipboard10.swf")), true);
        }
    }
}