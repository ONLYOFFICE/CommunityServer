...
namespace ASC.Web.Studio.UserControls.Management
{
    ...
    public partial class AuditTrail : UserControl
    {
        ...
        {
            Page.RegisterBodyScripts(ResolveUrl("~/usercontrols/management/audittrail/js/audittrail.js"));
            Page.RegisterStyleControl(VirtualPathUtility.ToAbsolute("~/usercontrols/management/audittrail/css/audittrail.less"));
