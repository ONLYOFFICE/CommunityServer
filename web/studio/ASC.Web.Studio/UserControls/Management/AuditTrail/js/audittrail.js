...
var AuditTrailView = function() {
    ...
    function createReport() {
        showLoader();
        $downloadReportBtn.addClass('disable');
        
        Teamlab.createAuditTrailReport({}, null, { success: createReportCallback, error: createReportErrorCallback });
    }

    function createReportCallback(params, fileUrl) {
        hideLoader();
        $downloadReportBtn.removeClass('disable');
