...
{
    public partial class VoipBuy : UserControl
    {
        public static string Location
        {
            get { return "~/UserControls/Management/TariffSettings/VoipBuy.ascx"; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CanBuy = voipQuotas.Any();

            VoipQuotas.DataSource = voipQuotas;
            VoipQuotas.DataBind();
        }
    }
}