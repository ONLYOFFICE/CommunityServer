...
<div id="restoreBlock" class="clearFix <%= isFree ? "disable" : "" %>">
    <div class="settings-block restore-setting_block ">
        ...
        <ul class="restore-settings_places clearFix">
            ...
            <li>
                <input id="restoreCloudAmazon" type="radio" name="restoreStorageVariants" value="2"/>
                <label for="restoreCloudAmazon"><%= Resource.BackupCloud %> Amazon</label>
            </li>
            <li>
        ...
        <div class="restore-settings_path">
            ...
            <div id="restoreAmazonSettings" class="restore-settings_amazon display-none">
                <input type="text" class="textEdit restore-settings_amazon_params access-key-id" placeholder="Access Key Id"/>
                <input type="text" class="textEdit restore-settings_amazon_params secret-access-key" placeholder="Secret Access Key" />
                <input type="text" class="textEdit restore-settings_amazon_params bucket" placeholder="Bucket Name" />
                <select class="textEdit restore-settings_amazon_params region">
                    <option value=""><%= Resource.ChooseRegion %></option>
                    <% foreach(var region in Regions ){ %>
                    <option value="<%= region.SystemName %>"><%= region.DisplayName %></option>
                    <%} %>
                </select>
                <input type="text" class="textEdit restore-settings_amazon_params file-path" placeholder="File URL" />
            </div>
            <div class="restore-setting_teamlab-file">
            ...
            <div class="restore-setting_computer-file">
