        ...
        <div class="clearFix ">
            ...
            <div class="clearFix logo-setting-block">
                <div class="header-base-small logo-header">
                    <%= String.Format("{0} ({1}x{2}):", WhiteLabelResource.LogoLight, TenantWhiteLabelSettings.logoLightSize.Width, TenantWhiteLabelSettings.logoLightSize.Height) %>
                </div>
                <div>
                    <div class="logo-img-container">
                        <img class="borderBase theme-background logo_<%= (int)WhiteLabelLogoTypeEnum.Light %>"
                            src="<%= String.Format("/TenantLogo.ashx?logotype={0}&general={1}", (int)WhiteLabelLogoTypeEnum.Light, (!IsRetina).ToString().ToLower())%>" />
                        <canvas id="canvas_logo_<%= (int)WhiteLabelLogoTypeEnum.Light %>" class="theme-background borderBase" width="432" height="70"
                            data-fontsize="54"
                            data-fontcolor="#fff">
