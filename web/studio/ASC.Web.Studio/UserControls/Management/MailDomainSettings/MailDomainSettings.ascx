...
<div class="clearFix">
     <div id="studio_domainSettings" class="settings-block">
      <div class="header-base clearFix" id="mailDomainSettingsTitle">
          ...
          <div class="clearFix">
              <div  class="clearFix">
                  <input id="offMailDomains" type="radio" value="<%=(int)TenantTrustedDomainsType.None %>" name="signInType" <%=_currentTenant.TrustedDomainsType == TenantTrustedDomainsType.None?"checked=\"checked\"":""%>/>     
                  <label class="header-base-small" for="offMailDomains"><%=Resource.OffMailDomains%></label>
              </div>
              <div  class="clearFix">
                   <input id="trustedMailDomains" type="radio" value="<%= (int)TenantTrustedDomainsType.Custom %>" name="signInType" <%=_currentTenant.TrustedDomainsType == TenantTrustedDomainsType.Custom?"checked=\"checked\"":""%>/>     
          ...
          <div id="trustedMailDomainsDescription" class="description" <%= _currentTenant.TrustedDomainsType == TenantTrustedDomainsType.Custom ? "" : "style=\"display:none;\"" %>>                
              ...
              <a href="javascript:void(0);" id="addTrustDomainBtn"><%= Resource.AddTrustedDomainButton %></a>
          ...
          <div class="middle-button-container">
              <a class="button blue" id="saveMailDomainSettingsBtn">
                  <%= Resource.SaveButton %></a>
          </div>

    </div>
    <div class="settings-help-block">
              <p><%= String.Format(Resource.HelpAnswerMailDomainSettings, "<br />","<b>","</b>")%></p>
