...
namespace ASC.Web.CRM.SocialMedia
{
    ...
    {
        public const string ConfigKeyTwitterConsumerKey = "twitterKey";
        public const string ConfigKeyTwitterConsumerSecretKey = "twitterSecret";

        public const string ConfigKeyTwitterDefaultAccessToken = "twitterAccessToken_Default";
