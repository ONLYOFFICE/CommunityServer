...
window.VoipCallsView = new function() {
    ...
    function getStoragePaging() {
        ...
        var pc = parseInt(localStorage[pageCountStorageKey]);
        var cp = parseInt(localStorage[currentPageStorageKey]);
    ...
    function saveStoragePaging() {
        ...
        localStorage[pageCountStorageKey] = pageCount;
        localStorage[currentPageStorageKey] = currentPage;
    }
    ...
    function getStorageFilterHash() {
        ...
        return localStorage[filterHashStorageKey];
    }
    ...
    function saveStorageFilterHash(filterHash) {
        ...
        localStorage[filterHashStorageKey] = '#' + filterHash;
    }
