...
<div class="page-menu">
    ...
    <ul class="menu-list">
        <li id="nav-menu-contacts" class="menu-item sub-list<%if(CurrentPage=="contacts"){%> active currentCategory<%}else
        ...
        <li id="nav-menu-tasks" class="menu-item none-sub-list<%if(CurrentPage=="tasks"){%> active<%}%>">
        ...
        <li id="nav-menu-deals" class="menu-item  none-sub-list<%if(CurrentPage=="deals"){%> active<%}%>">
        ...
        <li id="nav-menu-invoices" class="menu-item  sub-list<%if(CurrentPage=="invoices"){%> active currentCategory<%}%>">
            <div class="category-wrapper">
                <span class="expander"></span>
        ...
        <li id="nav-menu-cases" class="menu-item  none-sub-list<%if(CurrentPage=="cases"){%> active<%}%>">
        ...
        <li id="menuSettings" class="menu-item add-block sub-list<%if(CurrentPage.IndexOf("settings_", StringComparison.Ordinal)>-1){%> currentCategory<%}%>">
            ...
            <ul class="menu-sub-list">
                ...
                <li id="contactSettingsConteiner" class="menu-sub-item menu-item<%if(CurrentPage=="settings_contact_stage"|| CurrentPage=="settings_contact_type"){%> open<%}%>">
                    <div class="sub-list">
                ...
                <li class="menu-sub-item menu-item<%if(CurrentPage=="settings_invoice_items"|| CurrentPage=="settings_invoice_tax"||CurrentPage=="settings_organisation_profile"){%> open<%}%>">
                    <div class="sub-list">
                        <span class="expander"></span>
                    ...
                    <ul class="menu-sub-list">
                        <li class="menu-sub-item<%if(CurrentPage=="settings_invoice_items"){%> active<%}%>">
                        ...
                        <li class="menu-sub-item<%if(CurrentPage=="settings_invoice_tax"){%> active<%}%>">
                        ...
                        <li class="menu-sub-item<%if(CurrentPage=="settings_organisation_profile"){%> active<%}%>">
                ...
                <li class="menu-sub-item menu-item<%if(CurrentPage=="settings_custom_field"|| CurrentPage=="settings_history_category"||CurrentPage=="settings_task_category"||CurrentPage=="settings_deal_milestone"||CurrentPage=="settings_tag"){%> open<%}%>">
                    <div class="sub-list">
                        <span class="expander"></span>
                ...
                <li id="menuAccessRights" class="menu-sub-item">
                    <a class="menu-item-label outer-text text-overflow" href="<%=VirtualPathUtility.ToAbsolute("~/management.aspx")+ "?type=" + (int)ASC.Web.Studio.Utility.ManagementType.AccessRights +"#crm"%>">
