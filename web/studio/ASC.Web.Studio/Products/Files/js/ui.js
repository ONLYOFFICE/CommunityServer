...
window.ASC.Files.UI = (function () {
    ...
    var addRowHandlers = function (entryObject) {
        ...
        listEntry.each(function () {
            ...
            if (!entryObj.hasClass("checkloading")) {
                ...
                if (ASC.Files.Folders.folderContainer == "trash"
                    || entryData.error) {
                    rowLink.attr("href", ASC.Files.Constants.URL_BASE + "#" + ASC.Files.Common.getCorrectHash(ASC.Files.Folders.currentFolder.id));
                }
    ...
    var accessEdit = function (entryData, entryObj, review) {
    ...
    var checkButtonBack = function (buttonSelector, panelSelector) {
        if (ASC.Files.Tree && ASC.Files.Tree.pathParts.length > 1) {
            ...
            jq(buttonSelector)
                ...
                .attr("href", ASC.Files.Constants.URL_BASE + "#" + ASC.Files.Common.getCorrectHash(parentFolderId))
