...
namespace ASC.Web.Files.Resources {
    ...
    public class FilesJSResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to You are about to move elements from the {1} directory. In such a case, they will be deleted from your {1} account and will no longer be accessible to other users, if these elements have previously been shared. {0}Are you sure you want to move the elements?.
        /// </summary>
