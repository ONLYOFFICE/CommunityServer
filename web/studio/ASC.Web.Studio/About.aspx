...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="personal-page-container __about">
        ...
        <ul>
            <li><%=String.Format(Resource.AboutPersonalTheBestText1, "<b>", "</b>") %></li>
            <li><%= String.Format(Resource.AboutPersonalTheBestText2, "<b>", "</b>")%></li>
        </ul>
        ...
        <ul><%= String.Format(Resource.AboutPersonalEnableText, "<li>", "</li>") %></ul>

        <h2><%=Resource.AboutPersonalUseHeader %></h2>
        <p><%= Resource.AboutPersonalUseText %></p>

        <p><%= String.Format(Resource.AboutPersonalMoreInfoText, "<a target=\"_blank\" href=\"http://www.onlyoffice.com/\">", "</a>") %></p>

        <h2><%= Resource.AboutPersonalQuestionHeader %></h2>
        <p><%= String.Format(Resource.AboutPersonalQuestionText, 
