    ...
    public partial class Auth : MainPage
    {
        ...
        protected override void OnPreInit(EventArgs e)
        {
            ...
            if (IsLogout)
            {
                ...
                {
                    var ssoSettings = SettingsManager.Instance.LoadSettings<SsoSettings>(TenantProvider.CurrentTenantID);
                    if (ssoSettings.EnableSso && ssoSettings.TokenType == TokenTypes.SAML &&
                        !string.IsNullOrWhiteSpace(ssoSettings.SloEndPoint) && HttpContext.Current != null)
                    {
                        HttpContext.Current.Response.Redirect(ssoSettings.SloEndPoint, true);
                    }
                }
