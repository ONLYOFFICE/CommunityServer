...
namespace ASC.Web.Studio.HttpHandlers
{
    ...
    {
        private readonly static ILog _log = LogManager.GetLogger(typeof(JwtHandler));
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                tokenValidator.ValidateJsonWebToken(jwtEncodedString, settings, new List<string> { audience, audience + "/" });
