...
window.popup = (function($) {
    ...
    var _show = function(size, blockui_opts) {
    ...
    var addBig = function (header, body, onUnblock, to_begining, blockui_opts) {
        addPopup(header, body, '530px', onUnblock, to_begining, blockui_opts);
    };

    var addSmall = function (header, body, onUnblock, to_begining, blockui_opts) {
        addPopup(header, body, '350px', onUnblock, to_begining, blockui_opts);
    };

    var addPopup = function (header, body, size, onUnblock, to_begining, blockui_opts) {
