...
<div id="talkMeseditorContainer" class="disabled">
  ...
  <div id="talkMeseditorToolbarContainer">
    <div class="toolbar" unselectable="on">
      ...
      <div class="button-container send-file" id="talkFileUploaderFake" title="<%=TalkResource.HintSendFile%>" unselectable="on">
      </div>
      <div class="button-container send-file display-none" id="talkFileUploader" title="<%=TalkResource.HintSendFile%>" unselectable="on">
      </div>
