...
;window.TeamlabMobile = (function (TeamlabMobile) {
  ...
  var
    ...
    templateIds = {
      ...
      pgsomepage : 'template-page-some-page'
    },
    staticAnchors = {
    ...
    customEvents = {
      ...
      someEvent : 'on-modulename-someevent',
      someDialog : 'on-modulename-somedialog'
    },
    eventManager = TeamlabMobile.extendEventManager(customEvents),
    dialogMarkCollection = [
      
      {regexp : /^some\/add[\/]*$/, evt : customEvents.someDialog}
    ];
  ...
  ASC.Controls.AnchorController.bind(anchorRegExp.some, onSomeAnch);

  
  function onSomeAnch (params) {
    //
  }

  
  TeamlabMobile.someMethod = function () {
  };
