...
<script id="template-page-crm-contactpersones" type="text/x-jquery-tmpl" async="true">
<div class="ui-page page-crm-contactpersones ui-header ui-footer ui-fixed-footer">
  <div class="ui-header">
    <h1 class="ui-title"><%=Resources.MobileResource.CrmContactPersonsPage%></h1>
    ...
    <a class="ui-btn ui-btn-additem ui-btn-addcustomer ui-btn-right ui-btn-no-text target-self" href="#crm/contact/${id}/persone/add"><span class="ui-btn-inner"><span class="ui-btn-text"><span class="ui-btn-label">&nbsp;</span></span></span></a>
  </div>
    ...
    <div class="ui-scroller">      
      ...
      {{if items.length === 0}}
        <div class="ui-no-content">
          <span class="inner"><%=Resources.MobileResource.ErrCrmNoContactPersons%></span>
        </div>
      {{else}}
        <ul class="ui-timeline customers-timeline">
          {{tmpl({items:items}) '#template-crm-persones-timeline'}}
        </ul>
        {{if nextIndex}}        
  ...
  <div class="ui-footer">
    <div class="ui-navbar">
      ...
      <ul class="ui-grid ui-grid-5 nav-menu main-menu">
        ...
        <li class="ui-block filter-item persons current-filter">
