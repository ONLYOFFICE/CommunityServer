...
<script id="template-page-crm-contactfiles" type="text/x-jquery-tmpl" async="true">
<div class="ui-page page-crm-contactfiles ui-header ui-footer ui-fixed-footer">
  <div class="ui-header">
    ...
    <a class="ui-btn ui-btn-additem ui-btn-addperson ui-btn-right ui-btn-no-text target-self" href="#crm/contact/${contact.id}/add/file"><span class="ui-btn-inner"><span class="ui-btn-text"><span class="ui-btn-label">&nbsp;</span></span></span></a>
  </div>
  ...
  <div class="ui-scroller">      
      ...
      {{if items.length === 0}}
        <div class="ui-no-content">
          <span class="inner"><%=Resources.MobileResource.ErrCrmNoContactFiles%></span>
        </div>
      {{else}}
        <ul class="ui-timeline">
          {{each items}}
              <li class="item files">
                <a class="ui-item-link title ${target}" href="${href}">
                    <span class="inner-text">${title}</span>
                </a>
              </li>
          {{/each}}
        </ul>
    ...
    <div class="ui-navbar">
      ...
      <ul class="ui-grid ui-grid-5 nav-menu main-menu">
        ...
        <li class="ui-block filter-item files current-filter">
