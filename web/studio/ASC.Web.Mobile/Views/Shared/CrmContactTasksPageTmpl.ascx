...
<script id="template-page-crm-contacttasks" type="text/x-jquery-tmpl" async="true">
<div class="ui-page page-crm-contacttasks ui-header ui-footer ui-fixed-footer">
  <div class="ui-header">
    ...
    <a class="ui-btn ui-btn-additem ui-btn-addcustomer ui-btn-right ui-btn-no-text target-self" href="#crm/contact/${id}/add/task"><span class="ui-btn-inner"><span class="ui-btn-text"><span class="ui-btn-label">&nbsp;</span></span></span></a>
  </div>
    ...
    <div class="ui-scroller">      
      ...
      {{else}}
        <ul class="ui-timeline customers-timeline">
          {{tmpl({items:items, contactId:id}) '#template-crm-tasks-timeline'}}
        </ul>  
        {{if nextIndex}}      
  ...
  <div class="ui-footer">
    <div class="ui-navbar">
      ...
      <ul class="ui-grid ui-grid-5 nav-menu main-menu">
        ...
        <li class="ui-block filter-item tasks current-filter">
