        ...
        public void SetParent(HtmlNode parent)
        {
            ...
            if (OwnerDocument.OptionMaxNestedChildNodes > 0)
            {
                ...
                if (Depth > OwnerDocument.OptionMaxNestedChildNodes)
                    throw new RecursionDepthException(string.Format("Document has more than {0} nested tags. This is likely due to the page not closing tags properly.", OwnerDocument.OptionMaxNestedChildNodes));
            }
        }
