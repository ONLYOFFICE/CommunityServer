...
{
    internal class RestoreProgressItem : BackupProgressItemBase
    {
        private readonly string pathToBackupFile;

        public RestoreProgressItem(ILog log, int tenantId, string pathToBackupFile)
            : base(log, tenantId)
        {
