...
namespace ASC.Data.Storage.Configuration
{
    public class ModuleConfigurationElement : ConfigurationElement
    {
        ...
        [ConfigurationProperty(Schema.QUOTA, DefaultValue = long.MaxValue)]
        public long Quota
        {
        ...
        [ConfigurationProperty(Schema.OVERWRITE, DefaultValue = true)]
        ...
        [ConfigurationProperty(Schema.BASEDIR)]
