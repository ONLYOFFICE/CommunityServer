...
namespace ASC.SignalR.Base.Hubs.Chat
{
    public class ConnectionMapping
    {
        private readonly Dictionary<int, Dictionary<string, HashSet<string>>> _connections =
            new Dictionary<int, Dictionary<string, HashSet<string>>>(CoreContext.TenantManager.GetTenants().Count);
        ...
        public int Remove(int tenantId, string userName, string connectionId)
        {
            lock (_syncRoot)
            {
                Dictionary<string, HashSet<string>> connectionsOfUser;
