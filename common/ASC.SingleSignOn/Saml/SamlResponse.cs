...
namespace ASC.SingleSignOn.Saml
{
    public class SamlResponse
    {
        ...
        private readonly ILog log = LogManager.GetLogger(typeof(SamlResponse));

        public SamlResponse(SsoSettings ssoSettings)
        {
            _certificate = new Certificate();
            _certificate.LoadCertificate(ssoSettings.PublicKey);
        }
        ...
        public void LoadXml(string xml)
        {
            ...
            log.DebugFormat("SamlResponse: {0}", xmlDoc.InnerXml);
        }
        ...
        public string GetNameID()
        {
            ...
            if (node == null)
            {
                node = xmlDoc.SelectSingleNode(String.Format(
                    "/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='{0}']/saml:AttributeValue", ClaimTypes.Email), manager);
            }
        ...
        public string GetFirstName()
        {
            ...
            {
                node = xmlDoc.SelectSingleNode(String.Format(
                    "/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='{0}']/saml:AttributeValue", ClaimTypes.GivenName), manager);
            }
            return node != null ? node.InnerText : null;
        }
        ...
        public string GetLastName()
        {
            ...
            {
                node = xmlDoc.SelectSingleNode(String.Format(
                    "/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='{0}']/saml:AttributeValue", ClaimTypes.Surname), manager);
            }
            return node != null ? node.InnerText : null;
        }
        ...
        public string GetMobilePhone()
        {
            ...
            {
                node = xmlDoc.SelectSingleNode(String.Format(
                    "/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='{0}']/saml:AttributeValue", ClaimTypes.MobilePhone), manager);
            }
            return node != null ? node.InnerText : null;
        }
        ...
        public string GetStreetAddress()
        {
            ...
            {
                node = xmlDoc.SelectSingleNode(String.Format(
                    "/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='{0}']/saml:AttributeValue", ClaimTypes.Locality), manager);
            }
            return node != null ? node.InnerText : null;
        }
        ...
        public string GetBirthDate()
        {
            ...
            {
                node = xmlDoc.SelectSingleNode(String.Format(
                    "/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='{0}']/saml:AttributeValue", ClaimTypes.DateOfBirth), manager);
            }
            return node != null ? node.InnerText : null;
        }
        ...
        private bool IsValidEmail(string email)
        {
            if (email == null)
            {
                log.Error("No mandatory parameter: email");
                return false;
            }
            try
            {
