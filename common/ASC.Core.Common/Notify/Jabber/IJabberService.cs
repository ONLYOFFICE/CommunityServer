...
namespace ASC.Core.Notify.Jabber
{
    ...
    public interface IJabberService
    {
        ...
        void AddXmppConnection(string connectionId, string userName, byte state, int tenantId);

        [OperationContract]
        bool RemoveXmppConnection(string connectionId, string userName, int tenantId);
        ...
        [OperationContract(IsOneWay = true)]
        void SendState(int tenantId, string userName, byte state);
        ...
        [OperationContract]
        Dictionary<string, Dictionary<string, byte>> GetAllStates();
    }
}