...
namespace ASC.FullTextIndex
{
    ...
    {
        private readonly Dictionary<string, List<string>> results = new Dictionary<string, List<string>>();
        ...
        {
            return results.ContainsKey(identifier) ? results[identifier] : new List<string>();
        }
