...
namespace ASC.FederatedLogin.LoginProviders
{
    public class FacebookLoginProvider : ILoginProvider
    {
        ...
        private const string FacebookProfileScope = "email,user_about_me";

        public const string FacebookOauthCodeUrl = "https://www.facebook.com/dialog/oauth/";
        public const string FacebookOauthTokenUrl = "https://graph.facebook.com/oauth/access_token";
        ...
        {
            var facebookProfile = RequestHelper.PerformRequest(FacebookProfileUrl + "?access_token=" + token.AccessToken);
