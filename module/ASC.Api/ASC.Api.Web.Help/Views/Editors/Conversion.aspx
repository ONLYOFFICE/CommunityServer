...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<p class="dscr">Document conversion service is a part of Teamlab Office Apps. It lets the user convert files from one format into another to open them later in <b>document editors</b> or for their export.</p>
	...
	<ol>
		...
		<li>The <b>document storage service</b> sends the uploaded file to Teamlab Office Apps <b>document conversion service</b> for conversion into the Office Open XML format using the <a class="underline" href="<%=Url.Action("conversionapi") %>">conversion API</a>.</li>
	...
	<p>When the user needs to download the file in some format different from the Office Open XML format, Teamlab Office Apps convert the document file saved at the <b>document storage service</b> into the appropriate format prior to its export.</p>
	...
	<ol>
		...
		<li>The <b>document storage service</b> sends the uploaded file to Teamlab Office Apps <b>document conversion service</b> for conversion into the appropriate format using the <a class="underline" href="<%=Url.Action("conversionapi") %>">conversion API</a>.</li>
