...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table">
        ...
        <tbody>
            <tr class="tablerow">
                <td>documentType<span class="required">*</span></td>
                <td>defines the document type to be opened:
                    <em>open a text document (.docx, .doc, .odt, .txt) for viewing or editing</em> - <b>text</b>,
                    <em>open a PDF-document (.pdf) for viewing or editing</em> - <b>text-pdf</b>,
                    <em>open a spreadsheet (.xlsx, .xls, .ods) for viewing or editing</em> - <b>spreadsheet</b>,
                    <em>open a presentation (.pptx, .ppt, .odp) for viewing  or editing</em> - <b>presentation</b>
                </td>
                <td>string</td>
                <td>"spreadsheet"</td>
            </tr>
