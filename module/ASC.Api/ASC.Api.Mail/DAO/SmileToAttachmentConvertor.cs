...
namespace ASC.Api.Mail.DAO
{
    ...
    {
        private readonly Dictionary<string, MailAttachment> _loadedSmiles;

        public static string SmileBaseUrl
        {
            get { return "/usercontrols/common/ckeditor/plugins/smiley/teamlab_images"; }
        }

        public SmileToAttachmentConvertor()
        {
            _loadedSmiles = new Dictionary<string, MailAttachment>();
        }
