...
namespace ASC.Api.MailServer.DataContracts
{
    ...
    public class DnsData
    {
        ...
        [DataMember(IsRequired = true)]
        public MXRecordData MxRecord { get; set; }

        [DataMember(IsRequired = true)]
        public DNSRecordData SpfRecord { get; set; }

        [DataMember(IsRequired = true)]
        public DKIMRecordData DkimRecord { get; set; }

        [DataMember(IsRequired = true)]
        public DNSRecordData DomainCheckRecord { get; set; }
