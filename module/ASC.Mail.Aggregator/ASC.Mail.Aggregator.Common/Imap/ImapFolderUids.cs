...
namespace ASC.Mail.Aggregator.Common.Imap
{
    public class ImapFolderUids
    {
        ...
        public static bool operator ==(ImapFolderUids a, ImapFolderUids b)
        {
            ...
            return a.BeginDateUid == b.BeginDateUid && a.UnhandledUidIntervals.SequenceEqual(b.UnhandledUidIntervals);
        }
        ...
        {
            return BeginDateUid ^ UnhandledUidIntervals.GetHashCode();
        }
    }
}
