...
namespace ASC.Mail.Aggregator.Common.Logging
{
    ...
    {
        void Fatal(string message, params object[] param);
        void Fatal(Exception ex, string message, params object[] param);
        void Error(string message, params object[] param);
        void Error(Exception ex, string message, params object[] param);
        void Warn(string message, params object[] param);
        void Debug(string message, params object[] param);
        void WarnException(string format, Exception exception);
