        ...
        public static ILogger GetLogger(LoggerType type, string name)
        {
            switch (type)
            {
                case LoggerType.Nlog:
                    {
                        ConfigurationItemFactory.Default.LayoutRenderers.RegisterDefinition("syslogdir", typeof(Common.Logging.LayoutRenderers.SystemLogFolderLayoutRenderer));
                        ConfigurationItemFactory.Default.LayoutRenderers.RegisterDefinition("parentdir", typeof(Common.Logging.LayoutRenderers.ParentFolderLayoutRenderer));
