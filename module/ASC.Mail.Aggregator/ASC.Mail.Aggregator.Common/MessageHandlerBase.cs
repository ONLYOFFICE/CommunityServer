...
namespace ASC.Mail.Aggregator.Common
{
    public abstract class MessageHandlerBase
    {
        ...
        public readonly string connection_string_name;

        protected MessageHandlerBase(ILogger log, string connection_string_name)
        {
            this.log = log;
            this.connection_string_name = connection_string_name;
        }
