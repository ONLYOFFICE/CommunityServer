...
namespace ASC.Mail.Aggregator.Common.Extension
{
    ...
    {
        public static void LoadCalendarInfo(this MailMessage mail, MimeMessage message, ILogger log = null)
        {
            ...
            try
            {
                ...
                log.Debug("LoadCalendarInfo found {0} calendars", calendarParts.Count);
                ...
                foreach (var calendarPart in calendarParts)
                {
                    ...
                    log.Debug("Calendar UID: {0} Method: {1} ics: {2}", mail.CalendarUid, calendar.Method, mail.CalendarEventIcs);
        ...
        public static void ExtractMainParts(this MailMessage mail, MimeMessage message)
        {
        ...
        public static void LoadAttachments(this MailMessage mail, IEnumerable<MimeEntity> attachments, bool skipContentId = false)
        {
        ...
        public static void ReplaceEmbeddedImages(this MailMessage mail, ILogger log = null)
        {
            log = log ?? new NullLogger();
