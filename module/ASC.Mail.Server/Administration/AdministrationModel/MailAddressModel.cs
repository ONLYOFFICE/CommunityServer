...
{
    public class MailAddressModel : MailAddressBase, IMailAddress
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is IMailAddress)) return false;

            var other = (IMailAddress)obj;

            return Domain.Equals(other.Domain) && string.Equals(LocalPart, other.LocalPart) && Id == other.Id && Tenant == other.Tenant;
        }
