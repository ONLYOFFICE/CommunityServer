...
{
    public abstract class MailServerFactoryBase : IMailServerFactory
    {
        ...
        public abstract IMailAccount CreateMailAccount(IAccount teamlab_account, string login);

        public abstract IDnsSettings CreateDnsSettings(int id, int tenant, string user, string domain_name, string dkim_selector, string dkim_private_key,
