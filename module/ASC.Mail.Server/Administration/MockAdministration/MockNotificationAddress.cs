...
{
    internal class MockNotificationAddress : NotificationAddressModel
    {
        public MockNotificationAddress(string localpart, IWebDomain domain, string smtpServer, int smtpPort,
