...
{
    class MockDnsSettings: DnsSettingsModal
    {
        public MockDnsSettings(int id, int tenant, string user, string domain_name, string dkim_selector, string dkim_private_key,
