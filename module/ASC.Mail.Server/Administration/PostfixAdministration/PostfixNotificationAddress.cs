...
{
    internal class PostfixNotificationAddress : NotificationAddressModel
    {
        public PostfixNotificationAddress(string localpart, IWebDomain domain, string smtpServer, int smtpPort,
                                          string smtpAccount, bool smtpAuth, EncryptionType smptEncryptionType,
                                          AuthenticationType smtpAuthenticationType)
            : base(localpart, domain, smtpServer, smtpPort,
