...
namespace ASC.Mail.Server.PostfixAdministration
{
    public class PostfixConnectionStringParser
    {
        ...
        public PostfixConnectionStringParser(string connection_string)
        {
        ...
        private void Parse(string connection_string)
        {
            try
            {
                var parsed_connection = JObject.Parse(connection_string);
                PostfixAdminDbConnectionString = parsed_connection["DbConnection"].ToString();
            }
