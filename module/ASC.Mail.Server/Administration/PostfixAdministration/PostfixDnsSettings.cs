...
namespace ASC.Mail.Server.PostfixAdministration
{
    ...
    {
        public PostfixDnsSettings(int id, int tenant, string user, string domainName, string dkimSelector, string dkimPrivateKey,
            ...
            : base(id, tenant, user, domainName, dkimSelector, dkimPrivateKey, dkimPublicKey, domainCheckName,
