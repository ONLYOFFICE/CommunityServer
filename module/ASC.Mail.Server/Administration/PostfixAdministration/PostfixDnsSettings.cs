...
{
    class PostfixDnsSettings : DnsSettingsModal
    {
        public PostfixDnsSettings(int id, int tenant, string user, string domain_name, string dkim_selector, string dkim_private_key,
            ...
            : base(id, tenant, user, domain_name, dkim_selector, dkim_private_key, dkim_public_key, domain_check_name,
