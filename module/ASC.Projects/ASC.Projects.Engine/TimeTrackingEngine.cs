...
namespace ASC.Projects.Engine
{
    public class TimeTrackingEngine
    {
        ...
        public List<TimeSpend> GetByFilter(TaskFilter filter)
        {
            ...
            while (true)
            {
                var timeSpend = timeSpendDao.GetByFilter(filter, ProjectSecurity.CurrentUserAdministrator);
        ...
        {
            return timeSpendDao.GetByFilterTotal(filter, ProjectSecurity.CurrentUserAdministrator);
        }
