...
replace into tenants_quota (tenant, name, description, max_file_size, max_total_size, active_users, features, price, price2, avangate_id, visible) values (-2, 'trial', NULL, 1024, 1048575, 0, 'trial,backup,domain,docs', 0.00, 0.00, '23', 0);
replace into tenants_quota (tenant, name, description, max_file_size, max_total_size, active_users, features, price, price2, avangate_id, visible) values (-1, 'default', NULL, 1024, 1048575, 0, 'backup,domain', 0.00, 0.00, NULL, 0);

insert ignore into core_settings(tenant, id, value) values (-1, 'SmtpSettings', );
